...
This is adapted from official GitLab Docker images based on Ubuntu to use CentOS 6 as base image, while follow as close to official Omnibus package install as possible.
